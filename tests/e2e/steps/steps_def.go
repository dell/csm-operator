...
func (step *Step) generateAndCreateSftpSecrets(_ Resource, privateKeyPath, privateSecretName, publicSecretName, namespace, crType string) error {
	...
	if err := os.WriteFile(privateKeyFile, privateKeyData, 0o600); err != nil { // #nosec G303 G306 G703
	...
	if err := os.WriteFile(privateOut, privateKeyData, 0o600); err != nil { // #nosec G303 G306 G703
