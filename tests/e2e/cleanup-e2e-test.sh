...
rm -f cert-csi isilon.db vxflexos.db op-e2e-vxflexos.db powerscale.db powerscale-ifse2e.db powerstore.db unity.db controller-describe csm-describe node-describe
