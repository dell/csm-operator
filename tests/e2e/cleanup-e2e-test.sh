...
rm -f cert-csi isilon.db vxflexos.db op-e2e-vxflexos.db op-e2e-isilon.db powerscale.db powerscale-altifs.db powerscale-ifse2e.db powerstore.db unity.db controller-describe csm-describe node-describe
