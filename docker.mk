...
# Operator version tagged with build number. For e.g. - v1.5.1.001
VERSION ?= v1.5.1
...
# The image tag given to the resulting catalog image (e.g. make catalog-build CATALOG_IMG=example.com/operator-catalog:v1.5.1).
