...
// CRClient is an autogenerated mock type for the CRClient type
type CRClient struct {
	mock.Mock
}

// Create provides a mock function with given fields: ctx, obj, opts
func (_m *CRClient) Create(ctx context.Context, obj client.Object, opts ...client.CreateOption) error {
...
func (_m *CRClient) Delete(ctx context.Context, obj client.Object, opts ...client.DeleteOption) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *CRClient) DeleteAllOf(ctx context.Context, obj client.Object, opts ...client.DeleteAllOfOption) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *CRClient) Get(ctx context.Context, key types.NamespacedName, obj client.Object) error {
...
func (_m *CRClient) List(ctx context.Context, list client.ObjectList, opts ...client.ListOption) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *CRClient) Patch(ctx context.Context, obj client.Object, patch client.Patch, opts ...client.PatchOption) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *CRClient) RESTMapper() meta.RESTMapper {
	ret := _m.Called()
...
func (_m *CRClient) Scheme() *runtime.Scheme {
	ret := _m.Called()
...
func (_m *CRClient) Status() client.StatusWriter {
	ret := _m.Called()
...
func (_m *CRClient) Update(ctx context.Context, obj client.Object, opts ...client.UpdateOption) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
