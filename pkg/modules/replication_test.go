...
var config = tools.OperatorConfig{
...
func TestReplicationInjectDeployment(t *testing.T) {
	...
	tests := map[string]func(t *testing.T) (bool, applyv1.DeploymentApplyConfiguration, tools.OperatorConfig, csmv1.ContainerStorageModule){
		...
		"success - powermax injection": func(*testing.T) (bool, applyv1.DeploymentApplyConfiguration, tools.OperatorConfig, csmv1.ContainerStorageModule) {
...
func TestReplicationPreCheck(t *testing.T) {
	...
	tests := map[string]func(t *testing.T) (bool, csmv1.Module, csmv1.ContainerStorageModule, ctrlClient.Client, fakeControllerRuntimeClientWrapper){
		"success": func(*testing.T) (bool, csmv1.Module, csmv1.ContainerStorageModule, ctrlClient.Client, fakeControllerRuntimeClientWrapper) {
			...
			cluster1ConfigSecret := getSecret(tools.ReplicationControllerNameSpace, "test-target-cluster-1")
			cluster2ConfigSecret := getSecret(tools.ReplicationControllerNameSpace, "test-target-cluster-2")
...
func TestReplicationConfigmap(t *testing.T) {
	...
	realConfig := tools.OperatorConfig{
...
func TestReplicationCrdDeployAndDelete(t *testing.T) {
	tests := map[string]func(t *testing.T) (tools.OperatorConfig, csmv1.ContainerStorageModule, bool){
		"success case": func(_ *testing.T) (tools.OperatorConfig, csmv1.ContainerStorageModule, bool) {
			operConfig := tools.OperatorConfig{
				ConfigDirectory: "../../operatorconfig",
			}
			customResource, err := getCustomResource("./testdata/cr_powermax_replica.yaml")
			if err != nil {
		...
		"failure invalid config dir": func(_ *testing.T) (tools.OperatorConfig, csmv1.ContainerStorageModule, bool) {
			operConfig := tools.OperatorConfig{
		...
		"failure case no repl cr": func(_ *testing.T) (tools.OperatorConfig, csmv1.ContainerStorageModule, bool) {
			operConfig := tools.OperatorConfig{
				ConfigDirectory: "../../operatorconfig",
			}
