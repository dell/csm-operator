...
func getVeleroCrdDeploy(op tools.OperatorConfig, cr csmv1.ContainerStorageModule) (string, error) {
	yamlString := ""
...
func VeleroCrdDeploy(ctx context.Context, op tools.OperatorConfig, cr csmv1.ContainerStorageModule, ctrlClient crclient.Client) error {
...
func getAppMobCrdDeploy(op tools.OperatorConfig, cr csmv1.ContainerStorageModule) (string, error) {
	yamlString := ""
...
func AppMobCrdDeploy(ctx context.Context, op tools.OperatorConfig, cr csmv1.ContainerStorageModule, ctrlClient crclient.Client) error {
...
func getAppMobilityModuleDeployment(op tools.OperatorConfig, cr csmv1.ContainerStorageModule) (string, error) {
	yamlString := ""
	appMob, err := getAppMobilityModule(cr)
	if err != nil {
		return yamlString, err
...
func AppMobilityDeployment(ctx context.Context, isDeleting bool, op tools.OperatorConfig, cr csmv1.ContainerStorageModule, ctrlClient crclient.Client) error {
...
func getControllerManagerMetricService(op tools.OperatorConfig, cr csmv1.ContainerStorageModule) (string, error) {
	yamlString := ""
...
func ControllerManagerMetricService(ctx context.Context, isDeleting bool, op tools.OperatorConfig, cr csmv1.ContainerStorageModule, ctrlClient crclient.Client) error {
...
func getAppMobilityWebhookService(op tools.OperatorConfig, cr csmv1.ContainerStorageModule) (string, error) {
	yamlString := ""
	appMob, err := getAppMobilityModule(cr)
	if err != nil {
		return yamlString, err
...
func AppMobilityWebhookService(ctx context.Context, isDeleting bool, op tools.OperatorConfig, cr csmv1.ContainerStorageModule, ctrlClient crclient.Client) error {
...
func getIssuerCertService(op tools.OperatorConfig, cr csmv1.ContainerStorageModule) (string, error) {
	yamlString := ""
	appMob, err := getAppMobilityModule(cr)
	if err != nil {
		return yamlString, err
...
func IssuerCertService(ctx context.Context, isDeleting bool, op tools.OperatorConfig, cr csmv1.ContainerStorageModule, ctrlClient crclient.Client) error {
...
func ApplicationMobilityPrecheck(ctx context.Context, op tools.OperatorConfig, appMob csmv1.Module, _ csmv1.ContainerStorageModule, r tools.ReconcileCSM) error {
...
func AppMobilityCertManager(ctx context.Context, isDeleting bool, op tools.OperatorConfig, cr csmv1.ContainerStorageModule, ctrlClient crclient.Client) error {
...
func CreateVeleroAccess(ctx context.Context, isDeleting bool, op tools.OperatorConfig, cr csmv1.ContainerStorageModule, ctrlClient crclient.Client) error {
...
func getCreateVeleroAccess(op tools.OperatorConfig, cr csmv1.ContainerStorageModule) (string, error) {
	yamlString := ""
...
func AppMobilityVelero(ctx context.Context, isDeleting bool, op tools.OperatorConfig, cr csmv1.ContainerStorageModule, ctrlClient crclient.Client) error {
	var useSnap bool
	var nodeAgent bool
	envCredName := ""
	compCredName := ""
				...
				if c.Name == AppMobVeleroComponent {
					...
					for _, cred := range c.ComponentCred {
						...
						if cred.CreateWithInstall {
							...
							foundCred, _ := tools.GetSecret(ctx, compCredName, cr.Namespace, ctrlClient)
							if foundCred == nil {
							...
							foundCred, err := tools.GetSecret(ctx, envCredName, cr.Namespace, ctrlClient)
							if foundCred == nil {
	...
	if useSnap {
		...
		volumeSnapshotLoc, _ := tools.GetVolumeSnapshotLocation(ctx, vsName, cr.Namespace, ctrlClient)
		if volumeSnapshotLoc != nil {
			log.Infow("\n Volume Snapshot location Name : ", volumeSnapshotLoc.Name, " already exists and being re-used")
		}

		ctrlObjects, err := tools.GetModuleComponentObj([]byte(yamlString2))
		if err != nil {
			return err
		}
...
func getVelero(op tools.OperatorConfig, cr csmv1.ContainerStorageModule) (string, error) {
	yamlString := ""
...
func getUseVolumeSnapshot(_ context.Context, op tools.OperatorConfig, cr csmv1.ContainerStorageModule, _ crclient.Client) (string, string, error) {
	yamlString := ""
...
func getBackupStorageLoc(_ context.Context, op tools.OperatorConfig, cr csmv1.ContainerStorageModule, _ crclient.Client) (string, string, error) {
	yamlString := ""
...
func UseBackupStorageLoc(ctx context.Context, isDeleting bool, op tools.OperatorConfig, cr csmv1.ContainerStorageModule, ctrlClient crclient.Client) error {
	log := logger.GetLogger(ctx)
	...
	backupStorageLoc, _ := tools.GetBackupStorageLocation(ctx, bslName, cr.Namespace, ctrlClient)
...
func getNodeAgent(op tools.OperatorConfig, cr csmv1.ContainerStorageModule) (string, error) {
	yamlString := ""
...
func RemoveOldDaemonset(ctx context.Context, op tools.OperatorConfig, oldVersion string, cr csmv1.ContainerStorageModule, ctrlClient crclient.Client) error {
	log := logger.GetLogger(ctx)
