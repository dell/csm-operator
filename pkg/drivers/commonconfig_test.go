...
var (
	...
	tests = []struct {
		...
		{"pflex no-sdc path", csmForPowerFlex("no-common-section"), csmv1.PowerFlex, "node.yaml", ""},
		{"pflex with no common section", csmForPowerFlex("no-sdc"), csmv1.PowerFlex, "node.yaml", ""},
