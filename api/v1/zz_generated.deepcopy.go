...
func (in *ContainerTemplate) DeepCopyInto(out *ContainerTemplate) {
	*out = *in
	...
	in.StorageSystemCredentials.DeepCopyInto(&out.StorageSystemCredentials)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StorageSystemCredentials) DeepCopyInto(out *StorageSystemCredentials) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StorageSystemCredentials.
func (in *StorageSystemCredentials) DeepCopy() *StorageSystemCredentials {
	if in == nil {
		return nil
	}
	out := new(StorageSystemCredentials)
	in.DeepCopyInto(out)
	return out
}
