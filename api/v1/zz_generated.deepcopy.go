...
func (in *ContainerTemplate) DeepCopyInto(out *ContainerTemplate) {
	*out = *in
	...
	if in.SecretProviderClasses != nil {
		...
		*out = make([]StorageSystemSecretProviderClass, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StorageSystemSecretProviderClass) DeepCopyInto(out *StorageSystemSecretProviderClass) {
	*out = *in
	if in.Vaults != nil {
		in, out := &in.Vaults, &out.Vaults
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StorageSystemSecretProviderClass.
func (in *StorageSystemSecretProviderClass) DeepCopy() *StorageSystemSecretProviderClass {
	if in == nil {
		return nil
	}
	out := new(StorageSystemSecretProviderClass)
	in.DeepCopyInto(out)
	return out
}
