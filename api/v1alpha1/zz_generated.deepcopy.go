...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RemoteRepo) DeepCopyInto(out *RemoteRepo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RemoteRepo.
func (in *RemoteRepo) DeepCopy() *RemoteRepo {
	if in == nil {
		return nil
	}
	out := new(RemoteRepo)
